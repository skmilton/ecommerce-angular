...
export class ProductApiService {
  ...
  public getProductListById(productId: string): Observable<any> {
    ...
    updateProduct(productId: string, productName: string, code: string, description: string, qty: number,unitPrice:number,unitInStock:number,imageUrl:string): Observable<any> {
